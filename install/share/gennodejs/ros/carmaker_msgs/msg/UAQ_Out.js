...
class UAQ_Out {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.Vhcl_FL_rotv = null;
      this.Vhcl_FR_rotv = null;
      this.Vhcl_RL_rotv = null;
      this.Vhcl_RR_rotv = null;
      this.Vhcl_FL_rz = null;
      this.Vhcl_FR_rz = null;
      this.Vhcl_RL_rz = null;
      this.Vhcl_RR_rz = null;
    }
    else {
      ...
      if (initObj.hasOwnProperty('Vhcl_FL_rotv')) {
        this.Vhcl_FL_rotv = initObj.Vhcl_FL_rotv
      }
      else {
        this.Vhcl_FL_rotv = 0.0;
      }
      if (initObj.hasOwnProperty('Vhcl_FR_rotv')) {
        this.Vhcl_FR_rotv = initObj.Vhcl_FR_rotv
      }
      else {
        this.Vhcl_FR_rotv = 0.0;
      }
      if (initObj.hasOwnProperty('Vhcl_RL_rotv')) {
        this.Vhcl_RL_rotv = initObj.Vhcl_RL_rotv
      }
      else {
        this.Vhcl_RL_rotv = 0.0;
      }
      if (initObj.hasOwnProperty('Vhcl_RR_rotv')) {
        this.Vhcl_RR_rotv = initObj.Vhcl_RR_rotv
      }
      else {
        this.Vhcl_RR_rotv = 0.0;
      }
      if (initObj.hasOwnProperty('Vhcl_FL_rz')) {
        this.Vhcl_FL_rz = initObj.Vhcl_FL_rz
      }
      else {
        this.Vhcl_FL_rz = 0.0;
      }
      if (initObj.hasOwnProperty('Vhcl_FR_rz')) {
        this.Vhcl_FR_rz = initObj.Vhcl_FR_rz
      }
      else {
        this.Vhcl_FR_rz = 0.0;
      }
      if (initObj.hasOwnProperty('Vhcl_RL_rz')) {
        this.Vhcl_RL_rz = initObj.Vhcl_RL_rz
      }
      else {
        this.Vhcl_RL_rz = 0.0;
      }
      if (initObj.hasOwnProperty('Vhcl_RR_rz')) {
        this.Vhcl_RR_rz = initObj.Vhcl_RR_rz
      }
      else {
        this.Vhcl_RR_rz = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [Vhcl_FL_rotv]
    bufferOffset = _serializer.float64(obj.Vhcl_FL_rotv, buffer, bufferOffset);
    // Serialize message field [Vhcl_FR_rotv]
    bufferOffset = _serializer.float64(obj.Vhcl_FR_rotv, buffer, bufferOffset);
    // Serialize message field [Vhcl_RL_rotv]
    bufferOffset = _serializer.float64(obj.Vhcl_RL_rotv, buffer, bufferOffset);
    // Serialize message field [Vhcl_RR_rotv]
    bufferOffset = _serializer.float64(obj.Vhcl_RR_rotv, buffer, bufferOffset);
    // Serialize message field [Vhcl_FL_rz]
    bufferOffset = _serializer.float64(obj.Vhcl_FL_rz, buffer, bufferOffset);
    // Serialize message field [Vhcl_FR_rz]
    bufferOffset = _serializer.float64(obj.Vhcl_FR_rz, buffer, bufferOffset);
    // Serialize message field [Vhcl_RL_rz]
    bufferOffset = _serializer.float64(obj.Vhcl_RL_rz, buffer, bufferOffset);
    // Serialize message field [Vhcl_RR_rz]
    bufferOffset = _serializer.float64(obj.Vhcl_RR_rz, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [Vhcl_FL_rotv]
    data.Vhcl_FL_rotv = _deserializer.float64(buffer, bufferOffset);
    // Deserialize message field [Vhcl_FR_rotv]
    data.Vhcl_FR_rotv = _deserializer.float64(buffer, bufferOffset);
    // Deserialize message field [Vhcl_RL_rotv]
    data.Vhcl_RL_rotv = _deserializer.float64(buffer, bufferOffset);
    // Deserialize message field [Vhcl_RR_rotv]
    data.Vhcl_RR_rotv = _deserializer.float64(buffer, bufferOffset);
    // Deserialize message field [Vhcl_FL_rz]
    data.Vhcl_FL_rz = _deserializer.float64(buffer, bufferOffset);
    // Deserialize message field [Vhcl_FR_rz]
    data.Vhcl_FR_rz = _deserializer.float64(buffer, bufferOffset);
    // Deserialize message field [Vhcl_RL_rz]
    data.Vhcl_RL_rz = _deserializer.float64(buffer, bufferOffset);
    // Deserialize message field [Vhcl_RR_rz]
    data.Vhcl_RR_rz = _deserializer.float64(buffer, bufferOffset);
    return data;
  }
  ...
  static datatype() {
    ...
    return 'carmaker_msgs/UAQ_Out';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '8189520e40dab6c2672ce3055bcc2e5a';
  }
  ...
  static messageDefinition() {
    ...
    float64 Vhcl_FL_rotv                           # rad/s
    float64 Vhcl_FR_rotv                           # rad/s
    float64 Vhcl_RL_rotv                           # rad/s
    float64 Vhcl_RR_rotv                           # rad/s
    float64 Vhcl_FL_rz                             # rad
    float64 Vhcl_FR_rz                             # rad
    float64 Vhcl_RL_rz                             # rad
    float64 Vhcl_RR_rz                             # rad
  ...
  static Resolve(msg) {
    ...
    if (msg.Vhcl_FL_rotv !== undefined) {
      resolved.Vhcl_FL_rotv = msg.Vhcl_FL_rotv;
    }
    else {
      resolved.Vhcl_FL_rotv = 0.0
    }

    if (msg.Vhcl_FR_rotv !== undefined) {
      resolved.Vhcl_FR_rotv = msg.Vhcl_FR_rotv;
    }
    else {
      resolved.Vhcl_FR_rotv = 0.0
    }

    if (msg.Vhcl_RL_rotv !== undefined) {
      resolved.Vhcl_RL_rotv = msg.Vhcl_RL_rotv;
    }
    else {
      resolved.Vhcl_RL_rotv = 0.0
    }

    if (msg.Vhcl_RR_rotv !== undefined) {
      resolved.Vhcl_RR_rotv = msg.Vhcl_RR_rotv;
    }
    else {
      resolved.Vhcl_RR_rotv = 0.0
    }

    if (msg.Vhcl_FL_rz !== undefined) {
      resolved.Vhcl_FL_rz = msg.Vhcl_FL_rz;
    }
    else {
      resolved.Vhcl_FL_rz = 0.0
    }

    if (msg.Vhcl_FR_rz !== undefined) {
      resolved.Vhcl_FR_rz = msg.Vhcl_FR_rz;
    }
    else {
      resolved.Vhcl_FR_rz = 0.0
    }

    if (msg.Vhcl_RL_rz !== undefined) {
      resolved.Vhcl_RL_rz = msg.Vhcl_RL_rz;
    }
    else {
      resolved.Vhcl_RL_rz = 0.0
    }

    if (msg.Vhcl_RR_rz !== undefined) {
      resolved.Vhcl_RR_rz = msg.Vhcl_RR_rz;
    }
    else {
      resolved.Vhcl_RR_rz = 0.0
    }
