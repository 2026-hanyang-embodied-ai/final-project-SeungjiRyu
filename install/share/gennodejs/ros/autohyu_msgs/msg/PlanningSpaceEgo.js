...
class PlanningSpaceEgo {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new PlanningSpaceEgo(null);
  ...
  static datatype() {
    ...
    return 'autohyu_msgs/PlanningSpaceEgo';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'a7e39028661dc5d2bad0d2373d1ce403';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PlanningSpaceEgo(null);
...
module.exports = PlanningSpaceEgo;
