...
class Trajectory {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    for (let i = 0; i < len; ++i) {
      data.point[i] = TrajectoryPoint.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += 38 * object.point.length;
    return length + 6;
  }

  static datatype() {
    // Returns string type for a message object
    return 'autohyu_msgs/Trajectory';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '7f556d1db8e74efda59dc321a0e578ab';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.point !== undefined) {
      ...
      for (let i = 0; i < resolved.point.length; ++i) {
        resolved.point[i] = TrajectoryPoint.Resolve(msg.point[i]);
      }
    }
    else {
      resolved.point = []
