...
class TrajectoryBoundaryPoint {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TrajectoryBoundaryPoint(null);
  ...
  static datatype() {
    ...
    return 'autohyu_msgs/TrajectoryBoundaryPoint';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'be270bb113d640f7a5cca332fdcae3d2';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TrajectoryBoundaryPoint(null);
    if (msg.x !== undefined) {
      resolved.x = msg.x;
    }
    else {
...
module.exports = TrajectoryBoundaryPoint;
