...
class ObjectDimension {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ObjectDimension(null);
  ...
  static datatype() {
    ...
    return 'autohyu_msgs/ObjectDimension';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'd53e990829928c9e5c4832291f8458ce';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ObjectDimension(null);
...
module.exports = ObjectDimension;
