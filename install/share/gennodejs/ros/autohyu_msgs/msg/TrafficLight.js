...
class TrafficLight {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.uint16(obj.color, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.color = _deserializer.uint16(buffer, bufferOffset);
    return data;
  }
  ...
  static datatype() {
    ...
    return 'autohyu_msgs/TrafficLight';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '394746b82d513a53dacebe6e9186344b';
  }
