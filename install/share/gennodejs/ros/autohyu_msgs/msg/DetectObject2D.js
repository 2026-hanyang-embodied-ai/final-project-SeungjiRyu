...
class DetectObject2D {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = Object2DState.serialize(obj.state, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new DetectObject2D(null);
    ...
    data.state = Object2DState.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += Object2DState.getMessageSize(object.state);
    return length + 21;
  }

  static datatype() {
    // Returns string type for a message object
    return 'autohyu_msgs/DetectObject2D';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '5ef689afa95065f4db255a3c6a3ebf00';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new DetectObject2D(null);
    if (msg.id !== undefined) {
      resolved.id = msg.id;
    }
    else {
    ...
    if (msg.state !== undefined) {
      resolved.state = Object2DState.Resolve(msg.state)
    }
    else {
      resolved.state = new Object2DState()
    }
