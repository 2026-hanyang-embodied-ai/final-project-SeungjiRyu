...
if("FALSE" STREQUAL "TRUE")
  set(mrt_cmake_modules_SOURCE_PREFIX /home/ailab/git/HYU_Validation_Framework/src/lib/mrt_cmake_modules)
  set(mrt_cmake_modules_DEVEL_PREFIX /home/ailab/git/HYU_Validation_Framework/devel)
  ...
  set(mrt_cmake_modules_INSTALL_PREFIX /home/ailab/git/HYU_Validation_Framework/install)
...
if(NOT " " STREQUAL " ")
  ...
  set(_include_dirs "")
  if(NOT "http://wiki.ros.org/mrt_cmake_modules/issues " STREQUAL " ")
    set(_report "Check the issue tracker 'http://wiki.ros.org/mrt_cmake_modules/issues' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT "http://wiki.ros.org/mrt_cmake_modules " STREQUAL " ")
    set(_report "Check the website 'http://wiki.ros.org/mrt_cmake_modules' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Kevin Rösch <kevin.roesch@kit.edu>, Fabian Poggenhans <fabian.poggenhans@kit.edu>' and request to fix the problem.")
  endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(mrt_cmake_modules_EXPORTED_TARGETS ${${mrt_cmake_modules_dep}_EXPORTED_TARGETS})
endforeach()
