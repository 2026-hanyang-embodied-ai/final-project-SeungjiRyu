...
(cl:in-package carmaker_msgs-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <Init-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Init-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name carmaker_msgs-srv:<Init-request> is deprecated: use carmaker_msgs-srv:Init-request instead.")))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <Init-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader carmaker_msgs-srv:message-val is deprecated.  Use carmaker_msgs-srv:message instead.")
  (message m))
...
(cl:defmethod cl:initialize-instance :after ((m <Init-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Init-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name carmaker_msgs-srv:<Init-response> is deprecated: use carmaker_msgs-srv:Init-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <Init-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader carmaker_msgs-srv:success-val is deprecated.  Use carmaker_msgs-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'cycletime-val :lambda-list '(m))
(cl:defmethod cycletime-val ((m <Init-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader carmaker_msgs-srv:cycletime-val is deprecated.  Use carmaker_msgs-srv:cycletime instead.")
  (cycletime m))
