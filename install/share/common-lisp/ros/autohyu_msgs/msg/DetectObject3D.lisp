...
;//! \htmlinclude DetectObject3D.msg.html

(cl:defclass <DetectObject3D> (roslisp-msg-protocol:ros-message)
  ((id
    :reader id
    :initarg :id
    :type cl:integer
...
(cl:defclass DetectObject3D (<DetectObject3D>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <DetectObject3D>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'DetectObject3D)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autohyu_msgs-msg:<DetectObject3D> is deprecated: use autohyu_msgs-msg:DetectObject3D instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <DetectObject3D>))
...
(cl:defmethod confidence_score-val ((m <DetectObject3D>))
...
(cl:defmethod classification-val ((m <DetectObject3D>))
...
(cl:defmethod dimension-val ((m <DetectObject3D>))
...
(cl:defmethod state-val ((m <DetectObject3D>))
  ...
  (state m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <DetectObject3D>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <DetectObject3D>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DetectObject3D>)))
  "Returns string type for a message object of type '<DetectObject3D>"
  "autohyu_msgs/DetectObject3D")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DetectObject3D)))
  "Returns string type for a message object of type 'DetectObject3D"
  "autohyu_msgs/DetectObject3D")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<DetectObject3D>)))
  "Returns md5sum for a message object of type '<DetectObject3D>"
  "b926515bdab412f7168a089d08258b77")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'DetectObject3D)))
  "Returns md5sum for a message object of type 'DetectObject3D"
  "b926515bdab412f7168a089d08258b77")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<DetectObject3D>)))
  "Returns full string definition for message of type '<DetectObject3D>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'DetectObject3D)))
  "Returns full string definition for message of type 'DetectObject3D"
  (cl:format cl:nil "# Object information~%uint32 id~%float32 confidence_score~%uint8 classification~%~%autohyu_msgs/ObjectDimension dimension~%autohyu_msgs/Object3DState   state~%~%================================================================================~%MSG: autohyu_msgs/ObjectDimension~%float32 length~%float32 width~%float32 height~%~%================================================================================~%MSG: autohyu_msgs/Object3DState~%std_msgs/Header header~%~%float32 x~%float32 y~%float32 z~%float32 vx~%float32 vy~%float32 vz~%float32 ax~%float32 ay~%float32 az~%float32 roll~%float32 pitch~%float32 yaw~%float32 roll_rate~%float32 pitch_rate~%float32 yaw_rate~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <DetectObject3D>))
  (cl:+ 0
     4
     4
     1
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <DetectObject3D>))
  "Converts a ROS message object to a list"
  (cl:list 'DetectObject3D
    (cl:cons ':id (id msg))
