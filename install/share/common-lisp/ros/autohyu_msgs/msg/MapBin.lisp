...
(cl:defmethod cl:initialize-instance :after ((m <MapBin>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MapBin)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autohyu_msgs-msg:<MapBin> is deprecated: use autohyu_msgs-msg:MapBin instead.")))
