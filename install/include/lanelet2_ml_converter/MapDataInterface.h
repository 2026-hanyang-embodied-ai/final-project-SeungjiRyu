...
class MapDataInterface {
 public:
  ...
  void setCurrPosAndOnlyExtractSubmap(const BasicPoint3d& pt, double yaw, double pitch, double roll);
  LaneDataPtr laneData(bool processAll);
  LaneDataPtr centerlaneData(bool processAll);
 ...
 private:
  ...
  LaneDataPtr getCenterLaneData(LaneletSubmapConstPtr localSubmap, const OrientedRect& bbox,
                          double pitch, double roll, bool processAll);
