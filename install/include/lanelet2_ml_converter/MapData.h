...
class LaneData {
 public:
  ...
  static LaneDataPtr buildLaneletInstance(LaneletSubmapConstPtr& localSubmap, traffic_rules::TrafficRulesPtr trafficRules, bool ignoreMapElevation = false);
  bool processAll(const OrientedRect& bbox, const ParametrizationType& paramType, int32_t nPoints, double pitch = 0, double roll = 0);
  bool processOnlyLaneletInstance(const OrientedRect& bbox, const ParametrizationType& paramType, int32_t nPoints, double pitch = 0, double roll = 0);
 ...
 private:
  ...
  void initLaneletInstances(LaneletSubmapConstPtr& localSubmap, lanelet::routing::RoutingGraphConstPtr localSubmapGraph,
                            traffic_rules::TrafficRulesPtr trafficRules, bool ignoreMapElevation = false);
  void initLaneletInstancesOnlyCenter(LaneletSubmapConstPtr& localSubmap,
                            traffic_rules::TrafficRulesPtr trafficRules, bool ignoreMapElevation = false);
