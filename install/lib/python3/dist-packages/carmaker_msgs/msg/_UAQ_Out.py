...
"""autogenerated by genpy from carmaker_msgs/UAQ_Out.msg. Do not edit."""
import codecs
import sys
...
class UAQ_Out(genpy.Message):
  _md5sum = "8189520e40dab6c2672ce3055bcc2e5a"
  _type = "carmaker_msgs/UAQ_Out"
...
string frame_id
"""
  __slots__ = ['header','time','cycleno','synthdelay','Car_Roll','Car_Pitch','Car_Yaw','Car_vx','Car_vy','Car_vz','Car_RollVel','Car_PitchVel','Car_YawVel','Car_ax','Car_ay','Car_az','Car_RollAcc','Car_PitchAcc','Car_YawAcc','Steer_WhlAng','VC_Gas','VC_Brake','VC_SelectorCtrl','Sensor_Inertial_0_Vel_B_x','Sensor_Inertial_0_Vel_B_y','Sensor_Inertial_0_Vel_B_z','Sensor_Inertial_0_Omega_B_x','Sensor_Inertial_0_Omega_B_y','Sensor_Inertial_0_Omega_B_z','Sensor_Inertial_0_Acc_B_x','Sensor_Inertial_0_Acc_B_y','Sensor_Inertial_0_Acc_B_z','Sensor_Inertial_0_Aplha_B_x','Sensor_Inertial_0_Aplha_B_y','Sensor_Inertial_0_Aplha_B_z','Sensor_Inertial_1_Vel_B_x','Sensor_Inertial_1_Vel_B_y','Sensor_Inertial_1_Vel_B_z','Sensor_Inertial_1_Omega_B_x','Sensor_Inertial_1_Omega_B_y','Sensor_Inertial_1_Omega_B_z','Sensor_Inertial_1_Acc_B_x','Sensor_Inertial_1_Acc_B_y','Sensor_Inertial_1_Acc_B_z','Sensor_Inertial_1_Aplha_B_x','Sensor_Inertial_1_Aplha_B_y','Sensor_Inertial_1_Aplha_B_z','Vhcl_FL_rotv','Vhcl_FR_rotv','Vhcl_RL_rotv','Vhcl_RR_rotv','Vhcl_FL_rz','Vhcl_FR_rz','Vhcl_RL_rz','Vhcl_RR_rz']
  _slot_types = ['std_msgs/Header','time','int64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.Vhcl_FL_rotv is None:
        self.Vhcl_FL_rotv = 0.
      if self.Vhcl_FR_rotv is None:
        self.Vhcl_FR_rotv = 0.
      if self.Vhcl_RL_rotv is None:
        self.Vhcl_RL_rotv = 0.
      if self.Vhcl_RR_rotv is None:
        self.Vhcl_RR_rotv = 0.
      if self.Vhcl_FL_rz is None:
        self.Vhcl_FL_rz = 0.
      if self.Vhcl_FR_rz is None:
        self.Vhcl_FR_rz = 0.
      if self.Vhcl_RL_rz is None:
        self.Vhcl_RL_rz = 0.
      if self.Vhcl_RR_rz is None:
        self.Vhcl_RR_rz = 0.
    else:
      self.header = std_msgs.msg.Header()
      self.time = genpy.Time()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.time.secs, _x.time.nsecs, _x.cycleno, _x.synthdelay, _x.Car_Roll, _x.Car_Pitch, _x.Car_Yaw, _x.Car_vx, _x.Car_vy, _x.Car_vz, _x.Car_RollVel, _x.Car_PitchVel, _x.Car_YawVel, _x.Car_ax, _x.Car_ay, _x.Car_az, _x.Car_RollAcc, _x.Car_PitchAcc, _x.Car_YawAcc, _x.Steer_WhlAng, _x.VC_Gas, _x.VC_Brake, _x.VC_SelectorCtrl, _x.Sensor_Inertial_0_Vel_B_x, _x.Sensor_Inertial_0_Vel_B_y, _x.Sensor_Inertial_0_Vel_B_z, _x.Sensor_Inertial_0_Omega_B_x, _x.Sensor_Inertial_0_Omega_B_y, _x.Sensor_Inertial_0_Omega_B_z, _x.Sensor_Inertial_0_Acc_B_x, _x.Sensor_Inertial_0_Acc_B_y, _x.Sensor_Inertial_0_Acc_B_z, _x.Sensor_Inertial_0_Aplha_B_x, _x.Sensor_Inertial_0_Aplha_B_y, _x.Sensor_Inertial_0_Aplha_B_z, _x.Sensor_Inertial_1_Vel_B_x, _x.Sensor_Inertial_1_Vel_B_y, _x.Sensor_Inertial_1_Vel_B_z, _x.Sensor_Inertial_1_Omega_B_x, _x.Sensor_Inertial_1_Omega_B_y, _x.Sensor_Inertial_1_Omega_B_z, _x.Sensor_Inertial_1_Acc_B_x, _x.Sensor_Inertial_1_Acc_B_y, _x.Sensor_Inertial_1_Acc_B_z, _x.Sensor_Inertial_1_Aplha_B_x, _x.Sensor_Inertial_1_Aplha_B_y, _x.Sensor_Inertial_1_Aplha_B_z, _x.Vhcl_FL_rotv, _x.Vhcl_FR_rotv, _x.Vhcl_RL_rotv, _x.Vhcl_RR_rotv, _x.Vhcl_FL_rz, _x.Vhcl_FR_rz, _x.Vhcl_RL_rz, _x.Vhcl_RR_rz,) = _get_struct_2Iq52d().unpack(str[start:end])
      self.time.canon()
      return self
...
def _get_struct_I():
    ...
    return _struct_I
_struct_2Iq52d = None
def _get_struct_2Iq52d():
    global _struct_2Iq52d
    if _struct_2Iq52d is None:
        _struct_2Iq52d = struct.Struct("<2Iq52d")
    return _struct_2Iq52d
_struct_3I = None
def _get_struct_3I():
    global _struct_3I
